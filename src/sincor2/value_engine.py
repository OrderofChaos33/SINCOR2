...
def fetch_value_summary() -> dict:
    ...
    streams = [
        ...
        },
        {
            ...
            "note": f"~{hook_m}M SINC on $1.50+ USDC sell walls. Every USDC buy fills orders → treasury USDC.",
        },
        {
            "id": "platform",
    ...
    return {
        **s,
        "monetization_catalog": catalog_summary(),
        "treasury": TREASURY,
...
def social_pack(wallet: str | None = None) -> dict:
    ...
    tweet = (
        ...
        f"• ~{hook_m}M SINC on $1.50+ USDC sell walls\n"
        f"Buy: {ref}\n"
