...
• Official buy (USDC, $1.50/SINC floor): {buy}

{angle}

{ask}

Floor liquidity open now — ~2,667 SINC at $1.50 (~$4k block) via USDC on Base through our hook router. Buy: {buy}

Happy to give you an exclusive first look / demo — no ask beyond an honest look.
...
def render_message(partner: dict[str, Any], phase: str = "intro") -> str:
    ...
    ctx = {
        ...
        "buy": cfg.get("buy", "https://getsincor.com/sinc#buy-usdc"),
        "sinc": proof.get("sinc", ""),
