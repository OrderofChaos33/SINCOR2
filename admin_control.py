...
# Admin Authentication - Read from environment variables only
# Set in production via: export ADMIN_PASSWORD="your-secure-password"
# Use proper password hashing in production (bcrypt, Argon2)
def get_admin_users():
...
try:
    ...
    # Fallback: prevent any default credentials
    ADMIN_USERS = {}
