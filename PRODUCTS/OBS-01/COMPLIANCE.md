...
- Source implementation: `src/sincor2/monitoring_dashboard.py`
...
- Any pricing or readiness statement that conflicts with `/products/skus/OBS-01.json`.

## Evidence checklist

- Confirm `/products/skus/OBS-01.json` matches the outbound claim.
