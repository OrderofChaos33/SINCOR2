...
Register-OpsTask $Tasks.ReviewReminder $reminderArgs (New-ScheduledTaskTrigger -Daily -At $remAt) `
    "Email reminder to approve launch drafts (default: eenergy@protonmail.com)"
...
Write-Host "Review email: $remAt — eenergy@protonmail.com (set LAUNCH_REVIEW_ALERT_EMAIL)"
